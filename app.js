...
var $author$project$Main$allExercises = $elm$core$Array$fromList(
	_List_fromArray(
		[
...
var $author$project$Main$getNextExercise = F2(
	function (currentExercise, exercises) {
		var newExercise = A2($elm$core$Array$get, currentExercise + 1, exercises);
		if (newExercise.$ === 'Just') {
			var exercise = newExercise.a;
			return exercise;
		} else {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.description === 'ClickedMove') {
			...
			if (msg.description === 'ClickedDelete') {
				return _Utils_update(
					model,
					{
						userAnswer: A3(
							$elm$core$String$slice,
							0,
							$elm$core$String$length(model.userAnswer) - 1,
							model.userAnswer)
					});
			} else {
				if (msg.description === 'ClickedNext') {
...
var $author$project$Main$addDots = function (model) {
	var totalLength = $elm$core$String$length(model.correctAnswer);
	return A3(
...
var $author$project$Main$groupOf = F2(
	function (size, list) {
		if (size <= 0) {
			return _List_Nil;
		} else {
...
var $author$project$Main$parseMove = function (str) {
	return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{data: moveSymbol, description: 'ClickedMove'})
			]),
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('task-image-left'),
								$elm$html$Html$Attributes$src(model.fromPositionImage)
							]),
						_List_Nil),
						$elm$html$Html$text('        '),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('arrow-image'),
								$elm$html$Html$Attributes$src('arrow.png')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
						...
						A2(
							$elm$core$List$map,
							$author$project$Main$viewParsedMoves,
							$author$project$Main$parseMove(
								$author$project$Main$addDots(model)))),
						A2(
						$elm$html$Html$img,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('task-image-left'),
								$elm$html$Html$Attributes$src(model.toPositionImage)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Events$onClick(
												{data: '', description: 'ClickedDelete'})
											]),
										_List_fromArray(
											[
